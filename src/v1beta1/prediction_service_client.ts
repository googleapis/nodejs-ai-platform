...
export class PredictionServiceClient {
   ...
   * DeployModel must have {@link google.cloud.aiplatform.v1beta1.DeployedModel.explanation_spec|explanation_spec}
   * populated. If [ExplainRequest.deployed_model_id] is not specified, all
   * DeployedModels must have {@link google.cloud.aiplatform.v1beta1.DeployedModel.explanation_spec|explanation_spec}
