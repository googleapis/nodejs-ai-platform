...
export class MigrationServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the MigrationServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this.constructor as typeof MigrationServiceClient).scopes;
  ...
  /**
   * Check the status of the long running operation returned by the batchMigrateResources() method.
   * @param {String} name
   ...
   *   The first element is Array of [MigratableResource]{@link google.cloud.aiplatform.v1beta1.MigratableResource} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [SearchMigratableResourcesRequest]{@link google.cloud.aiplatform.v1beta1.SearchMigratableResourcesRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [SearchMigratableResourcesResponse]{@link google.cloud.aiplatform.v1beta1.SearchMigratableResourcesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  searchMigratableResources(
  ...
  /**
   * Equivalent to {@link searchMigratableResources}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link searchMigratableResources} continuously
  ...
  /**
   * Equivalent to {@link searchMigratableResources}, but returns an iterable object.
   *
