...
export class SpecialistPoolServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the SpecialistPoolServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this
      .constructor as typeof SpecialistPoolServiceClient).scopes;
  ...
  /**
   * Check the status of the long running operation returned by the createSpecialistPool() method.
   * @param {String} name
  ...
  /**
   * Check the status of the long running operation returned by the deleteSpecialistPool() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
  ...
  /**
   * Check the status of the long running operation returned by the updateSpecialistPool() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   *   The first element is Array of [SpecialistPool]{@link google.cloud.aiplatform.v1beta1.SpecialistPool} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListSpecialistPoolsRequest]{@link google.cloud.aiplatform.v1beta1.ListSpecialistPoolsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListSpecialistPoolsResponse]{@link google.cloud.aiplatform.v1beta1.ListSpecialistPoolsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listSpecialistPools(
  ...
  /**
   * Equivalent to {@link listSpecialistPools}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listSpecialistPools} continuously
  ...
  /**
   * Equivalent to {@link listSpecialistPools}, but returns an iterable object.
   *
