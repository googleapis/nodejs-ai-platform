...
export class JobServiceClient {
  ...
  /**
   * Check the status of the long running operation returned by the deleteCustomJob() method.
   * @param {String} name
  ...
  /**
   * Check the status of the long running operation returned by the deleteDataLabelingJob() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
  ...
  /**
   * Check the status of the long running operation returned by the deleteHyperparameterTuningJob() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
  ...
  /**
   * Check the status of the long running operation returned by the deleteBatchPredictionJob() method.
   * @param {String} name
   *   The operation name that will be passed.
   * @returns {Promise} - The promise which resolves to an object.
   *   The decoded operation object has result and metadata field to get information from.
   ...
   *   The first element is Array of [CustomJob]{@link google.cloud.aiplatform.v1beta1.CustomJob} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListCustomJobsRequest]{@link google.cloud.aiplatform.v1beta1.ListCustomJobsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListCustomJobsResponse]{@link google.cloud.aiplatform.v1beta1.ListCustomJobsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listCustomJobs(
  ...
  /**
   * Equivalent to {@link listCustomJobs}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listCustomJobs} continuously
  ...
  /**
   * Equivalent to {@link listCustomJobs}, but returns an iterable object.
   *
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [DataLabelingJob]{@link google.cloud.aiplatform.v1beta1.DataLabelingJob} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListDataLabelingJobsRequest]{@link google.cloud.aiplatform.v1beta1.ListDataLabelingJobsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListDataLabelingJobsResponse]{@link google.cloud.aiplatform.v1beta1.ListDataLabelingJobsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listDataLabelingJobs(
  ...
  /**
   * Equivalent to {@link listDataLabelingJobs}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listDataLabelingJobs} continuously
   * and invokes the callback registered for 'data' event for each element in the
   * responses.
   *
   * The returned object has 'end' method when no more elements are required.
  ...
  /**
   * Equivalent to {@link listDataLabelingJobs}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [HyperparameterTuningJob]{@link google.cloud.aiplatform.v1beta1.HyperparameterTuningJob} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListHyperparameterTuningJobsRequest]{@link google.cloud.aiplatform.v1beta1.ListHyperparameterTuningJobsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListHyperparameterTuningJobsResponse]{@link google.cloud.aiplatform.v1beta1.ListHyperparameterTuningJobsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listHyperparameterTuningJobs(
  ...
  /**
   * Equivalent to {@link listHyperparameterTuningJobs}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listHyperparameterTuningJobs} continuously
   * and invokes the callback registered for 'data' event for each element in the
   * responses.
   *
   * The returned object has 'end' method when no more elements are required.
  ...
  /**
   * Equivalent to {@link listHyperparameterTuningJobs}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [BatchPredictionJob]{@link google.cloud.aiplatform.v1beta1.BatchPredictionJob} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListBatchPredictionJobsRequest]{@link google.cloud.aiplatform.v1beta1.ListBatchPredictionJobsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListBatchPredictionJobsResponse]{@link google.cloud.aiplatform.v1beta1.ListBatchPredictionJobsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listBatchPredictionJobs(
  ...
  /**
   * Equivalent to {@link listBatchPredictionJobs}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listBatchPredictionJobs} continuously
   * and invokes the callback registered for 'data' event for each element in the
   * responses.
   *
   * The returned object has 'end' method when no more elements are required.
  ...
  /**
   * Equivalent to {@link listBatchPredictionJobs}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
