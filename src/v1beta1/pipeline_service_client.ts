...
export class PipelineServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the PipelineServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this.constructor as typeof PipelineServiceClient).scopes;
  ...
  /**
   * Check the status of the long running operation returned by the deleteTrainingPipeline() method.
   * @param {String} name
   ...
   *   The first element is Array of [TrainingPipeline]{@link google.cloud.aiplatform.v1beta1.TrainingPipeline} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListTrainingPipelinesRequest]{@link google.cloud.aiplatform.v1beta1.ListTrainingPipelinesRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListTrainingPipelinesResponse]{@link google.cloud.aiplatform.v1beta1.ListTrainingPipelinesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listTrainingPipelines(
  ...
  /**
   * Equivalent to {@link listTrainingPipelines}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listTrainingPipelines} continuously
  ...
  /**
   * Equivalent to {@link listTrainingPipelines}, but returns an iterable object.
   *
