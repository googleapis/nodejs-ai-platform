...
export class ModelServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the ModelServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this.constructor as typeof ModelServiceClient).scopes;
  ...
  /**
   * Check the status of the long running operation returned by the uploadModel() method.
   * @param {String} name
   ...
   *   The first element is Array of [Model]{@link google.cloud.aiplatform.v1beta1.Model} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListModelsRequest]{@link google.cloud.aiplatform.v1beta1.ListModelsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListModelsResponse]{@link google.cloud.aiplatform.v1beta1.ListModelsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listModels(
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [ModelEvaluation]{@link google.cloud.aiplatform.v1beta1.ModelEvaluation} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListModelEvaluationsRequest]{@link google.cloud.aiplatform.v1beta1.ListModelEvaluationsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListModelEvaluationsResponse]{@link google.cloud.aiplatform.v1beta1.ListModelEvaluationsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listModelEvaluations(
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [ModelEvaluationSlice]{@link google.cloud.aiplatform.v1beta1.ModelEvaluationSlice} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListModelEvaluationSlicesRequest]{@link google.cloud.aiplatform.v1beta1.ListModelEvaluationSlicesRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListModelEvaluationSlicesResponse]{@link google.cloud.aiplatform.v1beta1.ListModelEvaluationSlicesResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listModelEvaluationSlices(
  ...
  /**
   * Equivalent to {@link listModelEvaluationSlices}, but returns a NodeJS Stream object.
   *
   * This fetches the paged responses for {@link listModelEvaluationSlices} continuously
   * and invokes the callback registered for 'data' event for each element in the
   * responses.
   *
   * The returned object has 'end' method when no more elements are required.
  ...
  /**
   * Equivalent to {@link listModelEvaluationSlices}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
