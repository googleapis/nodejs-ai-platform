...
export class DatasetServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    // pass `{fallback: true}` to the DatasetServiceClient constructor.
    this._gaxModule = opts.fallback ? gax.fallback : gax;

    // Create a `gaxGrpc` object, with any grpc-specific options
    // sent to the client.
    opts.scopes = (this.constructor as typeof DatasetServiceClient).scopes;
   ...
   *   The first element is Array of [Dataset]{@link google.cloud.aiplatform.v1beta1.Dataset} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListDatasetsRequest]{@link google.cloud.aiplatform.v1beta1.ListDatasetsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListDatasetsResponse]{@link google.cloud.aiplatform.v1beta1.ListDatasetsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listDatasets(
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [DataItem]{@link google.cloud.aiplatform.v1beta1.DataItem} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListDataItemsRequest]{@link google.cloud.aiplatform.v1beta1.ListDataItemsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListDataItemsResponse]{@link google.cloud.aiplatform.v1beta1.ListDataItemsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listDataItems(
   ...
   *
   *   When autoPaginate: false is specified through options, the array has three elements.
   *   The first element is Array of [Annotation]{@link google.cloud.aiplatform.v1beta1.Annotation} that corresponds to
   *   the one page received from the API server.
   *   If the second element is not null it contains the request object of type [ListAnnotationsRequest]{@link google.cloud.aiplatform.v1beta1.ListAnnotationsRequest}
   *   that can be used to obtain the next page of the results.
   *   If it is null, the next page does not exist.
   *   The third element contains the raw response received from the API server. Its type is
   *   [ListAnnotationsResponse]{@link google.cloud.aiplatform.v1beta1.ListAnnotationsResponse}.
   *
   *   The promise has a method named "cancel" which cancels the ongoing API call.
   */
  listAnnotations(
  ...
  /**
   * Equivalent to {@link listAnnotations}, but returns an iterable object.
   *
   * for-await-of syntax is used with the iterable to recursively get response element on-demand.
   *
   * @param {Object} request
