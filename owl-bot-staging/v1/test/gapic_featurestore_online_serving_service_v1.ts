...
describe('v1.FeaturestoreOnlineServingServiceClient', () => {
    ...
    describe('readFeatureValues', () => {
        it('invokes readFeatureValues without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadFeatureValuesRequest());
            request.entityType = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadFeatureValuesResponse());
    ...
    describe('streamingReadFeatureValues', () => {
        it('invokes streamingReadFeatureValues without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.StreamingReadFeatureValuesRequest());
            request.entityType = '';
            const expectedHeaderRequestParams = "entity_type=";
            const expectedOptions = {
                otherArgs: {
