...
describe('v1.IndexEndpointServiceClient', () => {
    ...
    describe('getIndexEndpoint', () => {
        it('invokes getIndexEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetIndexEndpointRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.IndexEndpoint());
    ...
    describe('updateIndexEndpoint', () => {
        it('invokes updateIndexEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.UpdateIndexEndpointRequest());
    ...
    describe('createIndexEndpoint', () => {
        it('invokes createIndexEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateIndexEndpointRequest());
            request.parent = '';
    ...
    describe('deleteIndexEndpoint', () => {
        it('invokes deleteIndexEndpoint without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteIndexEndpointRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('undeployIndex', () => {
        it('invokes undeployIndex without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.UndeployIndexRequest());
            request.indexEndpoint = '';
            const expectedHeaderRequestParams = "index_endpoint=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('mutateDeployedIndex', () => {
        it('invokes mutateDeployedIndex without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.MutateDeployedIndexRequest());
            request.indexEndpoint = '';
            const expectedHeaderRequestParams = "index_endpoint=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listIndexEndpoints', () => {
        it('invokes listIndexEndpoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListIndexEndpointsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
