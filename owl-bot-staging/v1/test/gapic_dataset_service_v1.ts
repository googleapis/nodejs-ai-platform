...
describe('v1.DatasetServiceClient', () => {
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDatasetRequest', ['name']);
    ...
    describe('updateDataset', () => {
        it('invokes updateDataset without error', async () => {
            ...
            request.dataset ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateDatasetRequest', ['dataset', 'name']);
    ...
    describe('getAnnotationSpec', () => {
        it('invokes getAnnotationSpec without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAnnotationSpecRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDataset', () => {
        it('invokes createDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateDatasetRequest', ['parent']);
    ...
    describe('deleteDataset', () => {
        it('invokes deleteDataset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteDatasetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('importData', () => {
        it('invokes importData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('exportData', () => {
        it('invokes exportData without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportDataRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listDatasets', () => {
        it('invokes listDatasets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDatasetsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listDataItems', () => {
        it('invokes listDataItems without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDataItemsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listSavedQueries', () => {
        it('invokes listSavedQueries without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSavedQueriesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listAnnotations', () => {
        it('invokes listAnnotations without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAnnotationsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
