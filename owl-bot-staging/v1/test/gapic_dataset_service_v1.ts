...
describe('v1.DatasetServiceClient', () => {
    ...
    describe('getDataset', () => {
        it('invokes getDataset without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.Dataset());
    ...
    describe('getAnnotationSpec', () => {
        it('invokes getAnnotationSpec without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.AnnotationSpec());
    ...
    describe('listSavedQueries', () => {
        it('invokes listSavedQueries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListSavedQueriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
