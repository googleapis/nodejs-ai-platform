...
describe('v1.ModelServiceClient', () => {
    ...
    describe('getModel', () => {
        it('invokes getModel without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.Model());
    ...
    describe('mergeVersionAliases', () => {
        it('invokes mergeVersionAliases without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.MergeVersionAliasesRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('importModelEvaluation', () => {
        it('invokes importModelEvaluation without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelEvaluation());
    ...
    describe('batchImportModelEvaluationSlices', () => {
        it('invokes batchImportModelEvaluationSlices without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchImportModelEvaluationSlicesResponse());
    ...
    describe('getModelEvaluationSlice', () => {
        it('invokes getModelEvaluationSlice without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelEvaluationSlice());
    ...
    describe('deleteModelVersion', () => {
        it('invokes deleteModelVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteModelVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listModelVersions', () => {
        it('invokes listModelVersions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListModelVersionsRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
