...
describe('v1.PredictionServiceClient', () => {
    ...
    describe('predict', () => {
        it('invokes predict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.PredictRequest());
            request.endpoint = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.PredictResponse());
    ...
    describe('rawPredict', () => {
        it('invokes rawPredict without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.RawPredictRequest());
            request.endpoint = '';
            const expectedHeaderRequestParams = "endpoint=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.rawPredict as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('explain', () => {
        it('invokes explain without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ExplainRequest());
            request.endpoint = '';
            const expectedHeaderRequestParams = "endpoint=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ExplainResponse());
