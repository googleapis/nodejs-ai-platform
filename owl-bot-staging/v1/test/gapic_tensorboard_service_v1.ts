...
describe('v1.TensorboardServiceClient', () => {
    ...
    describe('getTensorboard', () => {
        it('invokes getTensorboard without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetTensorboardRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.Tensorboard());
    ...
    describe('createTensorboardExperiment', () => {
        it('invokes createTensorboardExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateTensorboardExperimentRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.TensorboardExperiment());
    ...
    describe('updateTensorboardExperiment', () => {
        it('invokes updateTensorboardExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.UpdateTensorboardExperimentRequest());
    ...
    describe('createTensorboardRun', () => {
        it('invokes createTensorboardRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateTensorboardRunRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.TensorboardRun());
    ...
    describe('batchCreateTensorboardRuns', () => {
        it('invokes batchCreateTensorboardRuns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchCreateTensorboardRunsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchCreateTensorboardRunsResponse());
    ...
    describe('getTensorboardRun', () => {
        it('invokes getTensorboardRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetTensorboardRunRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateTensorboardRun', () => {
        it('invokes updateTensorboardRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.UpdateTensorboardRunRequest());
    ...
    describe('batchCreateTensorboardTimeSeries', () => {
        it('invokes batchCreateTensorboardTimeSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchCreateTensorboardTimeSeriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchCreateTensorboardTimeSeriesResponse());
    ...
    describe('createTensorboardTimeSeries', () => {
        it('invokes createTensorboardTimeSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateTensorboardTimeSeriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.TensorboardTimeSeries());
    ...
    describe('batchReadTensorboardTimeSeriesData', () => {
        it('invokes batchReadTensorboardTimeSeriesData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchReadTensorboardTimeSeriesDataRequest());
            request.tensorboard = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchReadTensorboardTimeSeriesDataResponse());
    ...
    describe('readTensorboardTimeSeriesData', () => {
        it('invokes readTensorboardTimeSeriesData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadTensorboardTimeSeriesDataRequest());
            request.tensorboardTimeSeries = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadTensorboardTimeSeriesDataResponse());
    ...
    describe('writeTensorboardExperimentData', () => {
        it('invokes writeTensorboardExperimentData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.WriteTensorboardExperimentDataRequest());
            request.tensorboardExperiment = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.WriteTensorboardExperimentDataResponse());
    ...
    describe('writeTensorboardRunData', () => {
        it('invokes writeTensorboardRunData without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.WriteTensorboardRunDataResponse());
    ...
    describe('createTensorboard', () => {
        it('invokes createTensorboard without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateTensorboardRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteTensorboard', () => {
        it('invokes deleteTensorboard without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteTensorboardRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteTensorboardExperiment', () => {
        it('invokes deleteTensorboardExperiment without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteTensorboardExperimentRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteTensorboardRun', () => {
        it('invokes deleteTensorboardRun without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteTensorboardRunRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('readTensorboardBlobData', () => {
        it('invokes readTensorboardBlobData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadTensorboardBlobDataRequest());
            request.timeSeries = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ReadTensorboardBlobDataResponse());
    ...
    describe('listTensorboards', () => {
        it('invokes listTensorboards without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListTensorboardsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listTensorboardRuns', () => {
        it('invokes listTensorboardRuns without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListTensorboardRunsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listTensorboardTimeSeries', () => {
        it('invokes listTensorboardTimeSeries without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListTensorboardTimeSeriesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('exportTensorboardTimeSeriesData', () => {
        it('invokes exportTensorboardTimeSeriesData without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ExportTensorboardTimeSeriesDataRequest());
            request.tensorboardTimeSeries = '';
            const expectedHeaderRequestParams = "tensorboard_time_series=";
            const expectedOptions = {
                otherArgs: {
