...
describe('v1.JobServiceClient', () => {
    ...
    describe('createCustomJob', () => {
        it('invokes createCustomJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateCustomJobRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CustomJob());
    ...
    describe('getCustomJob', () => {
        it('invokes getCustomJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetCustomJobRequest());
            request.name = '';
    ...
    describe('cancelCustomJob', () => {
        it('invokes cancelCustomJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CancelCustomJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createDataLabelingJob', () => {
        it('invokes createDataLabelingJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DataLabelingJob());
    ...
    describe('getDataLabelingJob', () => {
        it('invokes getDataLabelingJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetDataLabelingJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('cancelDataLabelingJob', () => {
        it('invokes cancelDataLabelingJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CancelDataLabelingJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createHyperparameterTuningJob', () => {
        it('invokes createHyperparameterTuningJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.HyperparameterTuningJob());
    ...
    describe('cancelHyperparameterTuningJob', () => {
        it('invokes cancelHyperparameterTuningJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CancelHyperparameterTuningJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createBatchPredictionJob', () => {
        it('invokes createBatchPredictionJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateBatchPredictionJobRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.BatchPredictionJob());
    ...
    describe('cancelBatchPredictionJob', () => {
        it('invokes cancelBatchPredictionJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CancelBatchPredictionJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createModelDeploymentMonitoringJob', () => {
        it('invokes createModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.CreateModelDeploymentMonitoringJobRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ModelDeploymentMonitoringJob());
    ...
    describe('getModelDeploymentMonitoringJob', () => {
        it('invokes getModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.GetModelDeploymentMonitoringJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('pauseModelDeploymentMonitoringJob', () => {
        it('invokes pauseModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.PauseModelDeploymentMonitoringJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('resumeModelDeploymentMonitoringJob', () => {
        it('invokes resumeModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ResumeModelDeploymentMonitoringJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteCustomJob', () => {
        it('invokes deleteCustomJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteCustomJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteDataLabelingJob', () => {
        it('invokes deleteDataLabelingJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteDataLabelingJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteHyperparameterTuningJob', () => {
        it('invokes deleteHyperparameterTuningJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteHyperparameterTuningJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteBatchPredictionJob', () => {
        it('invokes deleteBatchPredictionJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteBatchPredictionJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updateModelDeploymentMonitoringJob', () => {
        it('invokes updateModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.UpdateModelDeploymentMonitoringJobRequest());
    ...
    describe('deleteModelDeploymentMonitoringJob', () => {
        it('invokes deleteModelDeploymentMonitoringJob without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.DeleteModelDeploymentMonitoringJobRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listDataLabelingJobs', () => {
        it('invokes listDataLabelingJobs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1.ListDataLabelingJobsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
