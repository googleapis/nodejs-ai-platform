...
import {Callback, CallOptions, Descriptors, ClientOptions, GrpcClientOptions, GoogleError, IamClient, IamProtos, LocationsClient, LocationProtos} from 'google-gax';
...
export class FeaturestoreOnlineServingServiceClient {
  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.stream = {
      streamingReadFeatureValues: new this._gaxModule.StreamDescriptor(gax.StreamType.SERVER_STREAMING, opts.fallback === 'rest')
    };
