...
export class MetadataServiceClient {
  ...
  initialize() {
    ...
    const metadataServiceStubMethods =
        ['createMetadataStore', 'getMetadataStore', 'listMetadataStores', 'deleteMetadataStore', 'createArtifact', 'getArtifact', 'listArtifacts', 'updateArtifact', 'createContext', 'getContext', 'listContexts', 'updateContext', 'deleteContext', 'addContextArtifactsAndExecutions', 'addContextChildren', 'queryContextLineageSubgraph', 'createExecution', 'getExecution', 'listExecutions', 'updateExecution', 'addExecutionEvents', 'queryExecutionInputsAndOutputs', 'createMetadataSchema', 'getMetadataSchema', 'listMetadataSchemas', 'queryArtifactLineageSubgraph'];
