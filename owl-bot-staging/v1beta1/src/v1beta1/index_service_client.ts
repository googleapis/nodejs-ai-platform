...
export class IndexServiceClient {
  ...
  initialize() {
    ...
    const indexServiceStubMethods =
        ['createIndex', 'getIndex', 'listIndexes', 'updateIndex', 'deleteIndex'];
 ...
 */
  async checkCreateIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Index, protos.google.cloud.aiplatform.v1beta1.CreateIndexOperationMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createIndex, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkUpdateIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.Index, protos.google.cloud.aiplatform.v1beta1.UpdateIndexOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.updateIndex, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkDeleteIndexProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteIndex, this._gaxModule.createDefaultBackoffSettings());
