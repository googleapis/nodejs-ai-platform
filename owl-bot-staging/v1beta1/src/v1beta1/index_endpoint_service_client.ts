 ...
 */
  async checkCreateIndexEndpointProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.IndexEndpoint, protos.google.cloud.aiplatform.v1beta1.CreateIndexEndpointOperationMetadata>>{
    ...
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createIndexEndpoint, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkDeleteIndexEndpointProgress(name: string): Promise<LROperation<protos.google.protobuf.Empty, protos.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteIndexEndpoint, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkDeployIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.DeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.DeployIndexOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deployIndex, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkUndeployIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.UndeployIndexResponse, protos.google.cloud.aiplatform.v1beta1.UndeployIndexOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.undeployIndex, this._gaxModule.createDefaultBackoffSettings());
 ...
 */
  async checkMutateDeployedIndexProgress(name: string): Promise<LROperation<protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexResponse, protos.google.cloud.aiplatform.v1beta1.MutateDeployedIndexOperationMetadata>>{
    const request = new operationsProtos.google.longrunning.GetOperationRequest({name});
    const [operation] = await this.operationsClient.getOperation(request);
    const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.mutateDeployedIndex, this._gaxModule.createDefaultBackoffSettings());
