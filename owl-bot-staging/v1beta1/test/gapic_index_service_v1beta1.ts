...
describe('v1beta1.IndexServiceClient', () => {
    ...
    describe('getIndex', () => {
        it('invokes getIndex without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Index());
    ...
    describe('upsertDatapoints', () => {
        it('invokes upsertDatapoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UpsertDatapointsRequest());
            request.index = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.UpsertDatapointsResponse());
    ...
    describe('removeDatapoints', () => {
        it('invokes removeDatapoints without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.RemoveDatapointsRequest());
            request.index = '';
            const expectedHeaderRequestParams = "index=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.RemoveDatapointsResponse());
