...
describe('v1beta1.DeploymentResourcePoolServiceClient', () => {
    ...
    describe('getDeploymentResourcePool', () => {
        it('invokes getDeploymentResourcePool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.GetDeploymentResourcePoolRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeploymentResourcePool());
            ...
            assert((client.innerApiCalls.getDeploymentResourcePool as SinonStub)
    ...
    describe('createDeploymentResourcePool', () => {
        it('invokes createDeploymentResourcePool without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.CreateDeploymentResourcePoolRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createDeploymentResourcePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteDeploymentResourcePool', () => {
        it('invokes deleteDeploymentResourcePool without error', async () => {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteDeploymentResourcePool as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listDeploymentResourcePools', () => {
        it('invokes listDeploymentResourcePools without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listDeploymentResourcePools as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('queryDeployedModels', () => {
        it('invokes queryDeployedModels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.QueryDeployedModelsRequest());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.queryDeployedModels as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with queryDeployedModels with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.QueryDeployedModelsRequest());
            request.deploymentResourcePool = '';
            const expectedHeaderRequestParams = "deployment_resource_pool=";const expectedError = new Error('expected');
