...
describe('v1beta1.MetadataServiceClient', () => {
    ...
    describe('getMetadataStore', () => {
        it('invokes getMetadataStore without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.MetadataStore());
    ...
    describe('createArtifact', () => {
        it('invokes createArtifact without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Artifact());
    ...
    describe('createContext', () => {
        it('invokes createContext without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Context());
    ...
    describe('addContextArtifactsAndExecutions', () => {
        it('invokes addContextArtifactsAndExecutions without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.AddContextArtifactsAndExecutionsResponse());
    ...
    describe('addContextChildren', () => {
        it('invokes addContextChildren without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.AddContextChildrenResponse());
    ...
    describe('queryContextLineageSubgraph', () => {
        it('invokes queryContextLineageSubgraph without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.LineageSubgraph());
    ...
    describe('createExecution', () => {
        it('invokes createExecution without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.Execution());
    ...
    describe('createMetadataSchema', () => {
        it('invokes createMetadataSchema without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.MetadataSchema());
    ...
    describe('deleteArtifact', () => {
        it('invokes deleteArtifact without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeleteArtifactRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('purgeArtifacts', () => {
        it('invokes purgeArtifacts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PurgeArtifactsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('purgeContexts', () => {
        it('invokes purgeContexts without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PurgeContextsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteExecution', () => {
        it('invokes deleteExecution without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.DeleteExecutionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('purgeExecutions', () => {
        it('invokes purgeExecutions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PurgeExecutionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
