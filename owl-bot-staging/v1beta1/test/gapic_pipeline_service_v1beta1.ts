...
describe('v1beta1.PipelineServiceClient', () => {
    ...
    describe('createTrainingPipeline', () => {
        it('invokes createTrainingPipeline without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.TrainingPipeline());
    ...
    describe('createPipelineJob', () => {
        it('invokes createPipelineJob without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.PipelineJob());
