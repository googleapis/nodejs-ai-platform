...
describe('v1beta1.FeaturestoreServiceClient', () => {
    ...
    describe('getFeaturestore', () => {
        it('invokes getFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetFeaturestoreRequest', ['name']);
    ...
    describe('getEntityType', () => {
        it('invokes getEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateEntityType', () => {
        it('invokes updateEntityType without error', async () => {
            ...
            request.entityType ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateEntityTypeRequest', ['entityType', 'name']);
    ...
    describe('updateFeature', () => {
        it('invokes updateFeature without error', async () => {
            ...
            request.feature ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateFeatureRequest', ['feature', 'name']);
    ...
    describe('createFeaturestore', () => {
        it('invokes createFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateFeaturestoreRequest', ['parent']);
    ...
    describe('updateFeaturestore', () => {
        it('invokes updateFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateFeaturestoreRequest', ['featurestore', 'name']);
    ...
    describe('deleteFeaturestore', () => {
        it('invokes deleteFeaturestore without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteFeaturestoreRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createEntityType', () => {
        it('invokes createEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateEntityTypeRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteEntityType', () => {
        it('invokes deleteEntityType without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteEntityTypeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('batchCreateFeatures', () => {
        it('invokes batchCreateFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchCreateFeaturesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('importFeatureValues', () => {
        it('invokes importFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ImportFeatureValuesRequest', ['entityType']);
    ...
    describe('batchReadFeatureValues', () => {
        it('invokes batchReadFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('BatchReadFeatureValuesRequest', ['featurestore']);
    ...
    describe('exportFeatureValues', () => {
        it('invokes exportFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ExportFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('deleteFeatureValues', () => {
        it('invokes deleteFeatureValues without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteFeatureValuesRequest', ['entityType']);
            request.entityType = defaultValue1;
            const expectedHeaderRequestParams = `entity_type=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listFeaturestores', () => {
        it('invokes listFeaturestores without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListFeaturestoresRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listEntityTypes', () => {
        it('invokes listEntityTypes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListEntityTypesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('searchFeatures', () => {
        it('invokes searchFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SearchFeaturesRequest', ['location']);
