...
describe('v1beta1.FeaturestoreOnlineServingServiceClient', () => {
    ...
    describe('readFeatureValues', () => {
        it('invokes readFeatureValues without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse());
            ...
            assert((client.innerApiCalls.readFeatureValues as SinonStub)
    ...
    describe('writeFeatureValues', () => {
        it('invokes writeFeatureValues without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.WriteFeatureValuesRequest());
            request.entityType = '';
            const expectedHeaderRequestParams = "entity_type=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.aiplatform.v1beta1.WriteFeatureValuesResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.writeFeatureValues as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('streamingReadFeatureValues', () => {
        it('invokes streamingReadFeatureValues without error', async () => {
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.streamingReadFeatureValues as SinonStub)
