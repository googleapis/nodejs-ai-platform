...
async function main(
  ...
  // [START aiplatform_create_data_labeling_job_video]
  /**
  ...
  async function createDataLabelingJobVideo() {
    ...
    const dataLabelingJob = {
      ...
      inputsSchemaUri: 'gs://google-cloud-aiplatform/schema/datalabelingjob/inputs/video_classification.yaml',
      inputs: inputs,
      annotationLabels: {
    ...
    console.log(`Create data labeling job video response`);
  ...
  // [END aiplatform_create_data_labeling_job_video]
  await createDataLabelingJobVideo();
}
