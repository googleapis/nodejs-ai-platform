...
function main(name) {
  // [START aiplatform_v1_generated_TensorboardService_GetTensorboard_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetTensorboard();
  // [END aiplatform_v1_generated_TensorboardService_GetTensorboard_async_sample]
}
