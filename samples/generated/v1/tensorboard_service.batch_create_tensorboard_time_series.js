...
function main(parent, requests) {
  // [START aiplatform_v1_generated_TensorboardService_BatchCreateTensorboardTimeSeries_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callBatchCreateTensorboardTimeSeries();
  // [END aiplatform_v1_generated_TensorboardService_BatchCreateTensorboardTimeSeries_async_sample]
}
