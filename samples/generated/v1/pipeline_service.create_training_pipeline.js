...
function main(parent, trainingPipeline) {
  // [START aiplatform_v1_generated_PipelineService_CreateTrainingPipeline_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callCreateTrainingPipeline();
  // [END aiplatform_v1_generated_PipelineService_CreateTrainingPipeline_async_sample]
}
