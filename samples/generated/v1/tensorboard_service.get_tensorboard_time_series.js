...
function main(name) {
  // [START aiplatform_v1_generated_TensorboardService_GetTensorboardTimeSeries_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetTensorboardTimeSeries();
  // [END aiplatform_v1_generated_TensorboardService_GetTensorboardTimeSeries_async_sample]
}
