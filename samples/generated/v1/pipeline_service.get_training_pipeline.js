...
function main(name) {
  // [START aiplatform_v1_generated_PipelineService_GetTrainingPipeline_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetTrainingPipeline();
  // [END aiplatform_v1_generated_PipelineService_GetTrainingPipeline_async_sample]
}
