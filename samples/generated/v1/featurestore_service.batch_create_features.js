...
function main(parent, requests) {
  // [START aiplatform_v1_generated_FeaturestoreService_BatchCreateFeatures_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callBatchCreateFeatures();
  // [END aiplatform_v1_generated_FeaturestoreService_BatchCreateFeatures_async_sample]
}
