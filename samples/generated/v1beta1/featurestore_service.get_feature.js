...
function main(name) {
  // [START aiplatform_v1beta1_generated_FeaturestoreService_GetFeature_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetFeature();
  // [END aiplatform_v1beta1_generated_FeaturestoreService_GetFeature_async_sample]
}
