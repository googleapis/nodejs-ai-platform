...
function main(name) {
  // [START aiplatform_v1beta1_generated_JobService_GetDataLabelingJob_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetDataLabelingJob();
  // [END aiplatform_v1beta1_generated_JobService_GetDataLabelingJob_async_sample]
}
