...
function main(execution) {
  ...
  async function callQueryExecutionInputsAndOutputs() {
    ...
    // Run request
    const response = await aiplatformClient.queryExecutionInputsAndOutputs(
      request
    );
...
function main(execution) {
  // [START aiplatform_v1beta1_generated_MetadataService_QueryExecutionInputsAndOutputs_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callQueryExecutionInputsAndOutputs();
  // [END aiplatform_v1beta1_generated_MetadataService_QueryExecutionInputsAndOutputs_async_sample]
}
...
main(...process.argv.slice(2));
>>>>>>> upstream/aribray--snippet-suffix
