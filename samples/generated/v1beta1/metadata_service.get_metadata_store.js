...
function main(name) {
  // [START aiplatform_v1beta1_generated_MetadataService_GetMetadataStore_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetMetadataStore();
  // [END aiplatform_v1beta1_generated_MetadataService_GetMetadataStore_async_sample]
}
