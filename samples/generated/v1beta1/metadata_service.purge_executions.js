...
function main(parent, filter) {
  // [START aiplatform_v1beta1_generated_MetadataService_PurgeExecutions_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callPurgeExecutions();
  // [END aiplatform_v1beta1_generated_MetadataService_PurgeExecutions_async_sample]
}
