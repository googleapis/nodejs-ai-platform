...
function main(name) {
  // [START aiplatform_v1beta1_generated_TensorboardService_DeleteTensorboard_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callDeleteTensorboard();
  // [END aiplatform_v1beta1_generated_TensorboardService_DeleteTensorboard_async_sample]
}
