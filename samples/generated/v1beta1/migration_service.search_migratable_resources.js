...
function main(parent) {
  ...
  async function callSearchMigratableResources() {
    ...
    // Run request
    const iterable = await aiplatformClient.searchMigratableResourcesAsync(
      request
    );
...
function main(parent) {
  // [START aiplatform_v1beta1_generated_MigrationService_SearchMigratableResources_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callSearchMigratableResources();
  // [END aiplatform_v1beta1_generated_MigrationService_SearchMigratableResources_async_sample]
}
