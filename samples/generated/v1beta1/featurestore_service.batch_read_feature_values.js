...
function main(featurestore, destination, entityTypeSpecs) {
  // [START aiplatform_v1beta1_generated_FeaturestoreService_BatchReadFeatureValues_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callBatchReadFeatureValues();
  // [END aiplatform_v1beta1_generated_FeaturestoreService_BatchReadFeatureValues_async_sample]
}
