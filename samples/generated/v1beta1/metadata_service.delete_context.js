...
function main(name) {
  // [START aiplatform_v1beta1_generated_MetadataService_DeleteContext_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callDeleteContext();
  // [END aiplatform_v1beta1_generated_MetadataService_DeleteContext_async_sample]
}
