...
function main(name) {
  // [START aiplatform_v1beta1_generated_SpecialistPoolService_GetSpecialistPool_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetSpecialistPool();
  // [END aiplatform_v1beta1_generated_SpecialistPoolService_GetSpecialistPool_async_sample]
}
