...
function main(parent, requests) {
  // [START aiplatform_v1beta1_generated_TensorboardService_BatchCreateTensorboardRuns_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callBatchCreateTensorboardRuns();
  // [END aiplatform_v1beta1_generated_TensorboardService_BatchCreateTensorboardRuns_async_sample]
}
