...
function main(name) {
  // [START aiplatform_v1beta1_generated_MetadataService_GetExecution_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetExecution();
  // [END aiplatform_v1beta1_generated_MetadataService_GetExecution_async_sample]
}
