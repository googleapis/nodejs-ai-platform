...
function main(parent) {
  // [START aiplatform_v1beta1_generated_MetadataService_ListArtifacts_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callListArtifacts();
  // [END aiplatform_v1beta1_generated_MetadataService_ListArtifacts_async_sample]
}
