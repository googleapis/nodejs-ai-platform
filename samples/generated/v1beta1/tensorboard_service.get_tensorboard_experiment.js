...
function main(name) {
  // [START aiplatform_v1beta1_generated_TensorboardService_GetTensorboardExperiment_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetTensorboardExperiment();
  // [END aiplatform_v1beta1_generated_TensorboardService_GetTensorboardExperiment_async_sample]
}
