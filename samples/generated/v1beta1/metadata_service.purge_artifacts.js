...
function main(parent, filter) {
  // [START aiplatform_v1beta1_generated_MetadataService_PurgeArtifacts_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callPurgeArtifacts();
  // [END aiplatform_v1beta1_generated_MetadataService_PurgeArtifacts_async_sample]
}
