...
function main(name) {
  // [START aiplatform_v1beta1_generated_PipelineService_GetPipelineJob_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callGetPipelineJob();
  // [END aiplatform_v1beta1_generated_PipelineService_GetPipelineJob_async_sample]
}
