...
function main(parent, pipelineJob) {
  // [START aiplatform_v1beta1_generated_PipelineService_CreatePipelineJob_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callCreatePipelineJob();
  // [END aiplatform_v1beta1_generated_PipelineService_CreatePipelineJob_async_sample]
}
