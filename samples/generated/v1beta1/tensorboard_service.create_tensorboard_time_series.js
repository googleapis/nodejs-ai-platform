...
function main(parent, tensorboardTimeSeries) {
  ...
  async function callCreateTensorboardTimeSeries() {
    ...
    // Run request
    const response = await aiplatformClient.createTensorboardTimeSeries(
      request
    );
...
function main(parent, tensorboardTimeSeries) {
  // [START aiplatform_v1beta1_generated_TensorboardService_CreateTensorboardTimeSeries_async_sample]
  /**
   * TODO(developer): Uncomment these variables before running the sample.
   */
  /**
  ...
  callCreateTensorboardTimeSeries();
  // [END aiplatform_v1beta1_generated_TensorboardService_CreateTensorboardTimeSeries_async_sample]
}
