...
const entityTypeDescription =
  'created during the delete entity type sample testing';
...
describe('AI platform delete entity type', async function () {
  this.retries(2);
  ...
  it('should delete the created entity type', async () => {
    const stdout = execSync(
      `node ./delete-entity-type-sample.js ${project} ${featurestoreId} ${entityTypeId} true ${location} ${apiEndpoint}`
    );
