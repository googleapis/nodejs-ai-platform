...
const entityTypeDescription =
  'created during update entity type with monitoring sample testing';
const duration = 172000;
...
describe('AI platform update entity type with monitoring', async function () {
  this.retries(2);
  ...
  it('should update the entity type', async () => {
    const stdout = execSync(
      `node ./update-entity-type-monitoring-sample.js ${project} ${featurestoreId} ${entityTypeId} ${duration} ${location} ${apiEndpoint}`
    );
