...
const entityTypeDescription =
  'created during the get entity type sample testing';
...
describe('AI platform get entity type', async function () {
  this.retries(2);
  ...
  it('should get the created entity type', async () => {
    const stdout = execSync(
      `node ./get-entity-type-sample.js ${project} ${featurestoreId} ${entityTypeId} ${location} ${apiEndpoint}`
    );
