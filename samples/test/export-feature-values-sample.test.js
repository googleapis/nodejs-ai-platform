...
describe('AI platform export feature values', async function () {
  this.retries(2);
  ...
  it('should export feature values', async () => {
    const stdout = execSync(
      `node ./export-feature-values-sample.js ${project} ${featurestoreId} ${entityTypeId} "${destinationTableUri}" ${location} ${apiEndpoint}`
    );
