...
const entityTypeDescription =
  'created during list features stream sample testing';
const featureId = `feature_sample_${uuid().replace(/-/g, '_').slice(10, 20)}`;
const featureDescription = 'created during list features stream sample testing';
...
describe('AI platform list features stream', async function () {
  this.retries(2);
