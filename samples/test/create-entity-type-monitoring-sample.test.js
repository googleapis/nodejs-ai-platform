...
const description =
  'created during the create entity type with monitoring sample testing';
...
describe('AI platform create entity type with monitoring', async function () {
  this.retries(2);
  ...
  it('should create the entity type', async () => {
    const stdout = execSync(
      `node ./create-entity-type-monitoring-sample.js ${project} ${featurestoreId} ${entityTypeId} "${description}" ${duration} ${location} ${apiEndpoint}`
    );
