...
const entityTypeDescription =
  'created during update entity type sample testing';
...
describe('AI platform update entity type', async function () {
  this.retries(2);
  ...
  it('should update the entity type', async () => {
    const stdout = execSync(
      `node ./update-entity-type-sample.js ${project} ${featurestoreId} ${entityTypeId} ${location} ${apiEndpoint}`
    );
