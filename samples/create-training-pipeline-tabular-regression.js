...
async function main(
  ...
  async function createTrainingPipelineTablesRegression() {
    ...
    let trainingTaskInputsObj = new definition.AutoMlTablesInputs({
      transformations,
      targetColumn,
    ...
    console.log(`Create training pipeline tables regression response`);
  ...
  await createTrainingPipelineTablesRegression();
}
