...
async function main(
  ...
  // [START aiplatform_create_training_pipeline_tabular_regression]
  /**
  ...
  async function createTrainingPipelineTabularRegression() {
    ...
    const transformations = {
      listValue: {
        values: [
          ...
          {
            numeric: {
              columnName: 'SC_Commodity_ID',
              invalidValuesAllowed: false,
            },
          },
          {text: {columnName: 'SC_Commodity_Desc'}},
          {
            numeric: {
              columnName: 'SC_Attribute_ID',
              invalidValuesAllowed: false,
            },
          },
  ...
  await createTrainingPipelineTabularRegression();
  // [END aiplatform_create_training_pipeline_tabular_regression]
}
