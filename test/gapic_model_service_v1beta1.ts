...
describe('v1beta1.ModelServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      modelserviceModule.v1beta1.ModelServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      modelserviceModule.v1beta1.ModelServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes getModel without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getModel(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IModel | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getModelEvaluation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getModelEvaluation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IModelEvaluation | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getModelEvaluationSlice', () => {
    ...
    it('invokes getModelEvaluationSlice without error using callback', async () => {
      ...
      client.innerApiCalls.getModelEvaluationSlice = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getModelEvaluationSlice(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IModelEvaluationSlice | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('uploadModel', () => {
    ...
    it('invokes uploadModel without error using callback', async () => {
      ...
      client.innerApiCalls.uploadModel = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.uploadModel(
  ...
  describe('listModels', () => {
    ...
    it('invokes listModelsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.aiplatform.v1beta1.Model) => {
    ...
    it('invokes listModelEvaluationsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ModelEvaluation
          ) => {
            responses.push(response);
          }
        );
  ...
  describe('listModelEvaluationSlices', () => {
    ...
    it('invokes listModelEvaluationSlices without error using callback', async () => {
      ...
      client.innerApiCalls.listModelEvaluationSlices = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listModelEvaluationSlicesStream without error', async () => {
      ...
      client.descriptors.page.listModelEvaluationSlices.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice
          ) => {
            responses.push(response);
          }
        );
    ...
    it('uses async iteration with listModelEvaluationSlices without error', async () => {
      ...
      client.descriptors.page.listModelEvaluationSlices.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
