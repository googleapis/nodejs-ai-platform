...
describe('v1beta1.IndexEndpointServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      indexendpointserviceModule.v1beta1.IndexEndpointServiceClient.port;
    assert(port);
    ...
    it('invokes getIndexEndpoint without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getIndexEndpoint(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IIndexEndpoint | null
          ) => {
            if (err) {
              reject(err);
            } else {
