...
describe('v1beta1.PipelineServiceClient', () => {
  ...
  describe('createPipelineJob', () => {
    ...
    it('invokes createPipelineJob without error using callback', async () => {
      ...
      client.innerApiCalls.createPipelineJob = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('getPipelineJob', () => {
    ...
    it('invokes getPipelineJob without error using callback', async () => {
      ...
      client.innerApiCalls.getPipelineJob = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('deletePipelineJob', () => {
    ...
    it('invokes deletePipelineJob without error using callback', async () => {
      ...
      client.innerApiCalls.deletePipelineJob = stubLongRunningCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('listPipelineJobs', () => {
    ...
    it('invokes listPipelineJobs without error using callback', async () => {
      ...
      client.innerApiCalls.listPipelineJobs = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listPipelineJobsStream without error', async () => {
      ...
      client.descriptors.page.listPipelineJobs.createStream = stubPageStreamingCall(
        expectedResponse
      );
      ...
      assert.strictEqual(
        (client.descriptors.page.listPipelineJobs
          .createStream as SinonStub).getCall(0).args[2].otherArgs.headers[
          'x-goog-request-params'
        ],
        expectedHeaderRequestParams
    ...
    it('uses async iteration with listPipelineJobs without error', async () => {
      ...
      client.descriptors.page.listPipelineJobs.asyncIterate = stubAsyncIterationCall(
        expectedResponse
      );
