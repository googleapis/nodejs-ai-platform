...
describe('v1beta1.FeaturestoreServiceClient', () => {
  it('has servicePath', () => {
    const servicePath =
      featurestoreserviceModule.v1beta1.FeaturestoreServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      featurestoreserviceModule.v1beta1.FeaturestoreServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });

  it('has port', () => {
    const port =
      featurestoreserviceModule.v1beta1.FeaturestoreServiceClient.port;
    assert(port);
    ...
    it('invokes getFeaturestore without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getFeaturestore(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IFeaturestore | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getEntityType without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getEntityType(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.aiplatform.v1beta1.IEntityType | null
          ) => {
            if (err) {
              reject(err);
            } else {
